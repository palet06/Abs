...
namespace Abs.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ManagerId,Name,Surname,Title")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ManagerId,Name,Surname,Title")] Manager manager)
        {
            if (ModelState.IsValid)
            {
